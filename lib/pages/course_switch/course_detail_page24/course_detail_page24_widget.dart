...
import 'course_detail_page24_model.dart';
export 'course_detail_page24_model.dart';

class CourseDetailPage24Widget extends StatefulWidget {
  const CourseDetailPage24Widget({Key? key}) : super(key: key);

  @override
  _CourseDetailPage24WidgetState createState() =>
      _CourseDetailPage24WidgetState();
}

class _CourseDetailPage24WidgetState extends State<CourseDetailPage24Widget> {
  late CourseDetailPage24Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CourseDetailPage24Model());
