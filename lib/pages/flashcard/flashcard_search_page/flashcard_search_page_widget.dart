...
import 'flashcard_search_page_model.dart';


class FlashcardSearchPageWidget extends StatefulWidget {
  const FlashcardSearchPageWidget({Key? key}) : super(key: key);

  @override
  _FlashcardSearchPageWidgetState createState() =>
      _FlashcardSearchPageWidgetState();
}

class _FlashcardSearchPageWidgetState extends State<FlashcardSearchPageWidget> {
  late FlashcardSearchPageModel _model;
  ...
  void initState() {
    super.initState();
    FirebaseAnalytics.instance.setCurrentScreen(screenName: "FlashcardSearchPage");
    CleverTapService.recordPageView("Flashcard Search Page Opened");
    loadSearchHistory();
    _model = createModel(context, () => FlashcardSearchPageModel());
  ...
  void loadSearchHistory() async {
    ...
    List<dynamic>? searchHistoryStrings = prefs.getStringList('FlashcardSearchHistory');
  ...
  void saveSearchHistory() async {
    ...
    List<String> searchHistoryStrings = searchHistory
        ...
        .toList();
    await prefs.setStringList('FlashcardSearchHistory', searchHistoryStrings);
  }
