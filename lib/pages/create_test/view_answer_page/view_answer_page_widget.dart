...
class _ViewAnswerPageWidgetState extends State<ViewAnswerPageWidget> {
  ...
  void initState() {
    super.initState();
    FirebaseAnalytics.instance.setCurrentScreen(screenName: "ViewAnswerPage",);
    CleverTapService.recordEvent("View Answer Page Opened",{"testAttemptId":widget.testAttemptId});
                                                                              ...
                                                                              if ((String var1) {
                                                                                ...
                                                                                Container(
                                                                                  ...
                                                                                  child: custom_widgets.CustomWebView(
                                                                                    width:  MediaQuery.sizeOf(context).width * 0.9,
                                                                                    height:MediaQuery.sizeOf(context).height ,
                                                                                    src: '${functions.converHtmlIntoString(getJsonField(
                                                                                      quetionListItem,
                                                                                      r'''$.explanation''',
                                                                                    ).toString())}',
                                                                                  ),
