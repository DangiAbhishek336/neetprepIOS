...
import 'bookmarked_search_page_model.dart';


class BookmarkedSearchPageWidget extends StatefulWidget {
  const BookmarkedSearchPageWidget({Key? key,String? courseId}) : this.courseId = courseId ?? null,super(key: key);

  final String? courseId;

  @override
  _BookmarkedSearchPageWidgetState createState() =>
      _BookmarkedSearchPageWidgetState();
}

class _BookmarkedSearchPageWidgetState extends State<BookmarkedSearchPageWidget> {
  late BookmarkedSearchPageModel _model;
  ...
  void initState() {
    super.initState();
    FirebaseAnalytics.instance.setCurrentScreen(screenName: "BookmarkedSearchPage");
    CleverTapService.recordPageView("Bookmarked Search Page Opened");
    loadSearchHistory();
    _model = createModel(context, () => BookmarkedSearchPageModel());
  ...
  void loadSearchHistory() async {
    ...
    List<dynamic>? searchHistoryStrings = prefs.getStringList('bookmarksSearchHistory');
  ...
  void saveSearchHistory() async {
    ...
    List<String> searchHistoryStrings = searchHistory
        ...
        .toList();
    await prefs.setStringList('bookmarksSearchHistory', searchHistoryStrings);
  }
