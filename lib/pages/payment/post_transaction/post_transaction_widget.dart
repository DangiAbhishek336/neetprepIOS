...
class _PostTransactionWidgetState extends State<PostTransactionWidget> {
  ...
  void initState() {
    ...
    FirebaseAnalytics.instance.setCurrentScreen(screenName: "PostTransactionPage",);
    CleverTapService.recordEvent("Post Transaction Page Opened", {
      "Payment Status": widget.success,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Text(
                            widget.success
                                ? 'Your enrolment details will be sent to you shortly. For any further assistance write us on support@neetprep.com'
                                : 'Please try again after sometime. For any further assistance write us on support@neetprep.com',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: FlutterFlowTheme.of(context)
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          if (widget.success) {
                            if(widget.course == FFAppState().courseIdInt.toString())
                            context.pushNamed('PracticeChapterWisePage');
                            else if(widget.course==FFAppState().testCourseIdInt.toString())
                              context.pushNamed('CreateAndPreviewTestPage');
                            else if(widget.course== FFAppState().classroomTestCourseIdInt.toString())
                              context.pushNamed('ClassroomTestSeriesPage');
                            else if(widget.course==FFAppState().flashcardCourseIdInt.toString())
                              context.pushNamed('FlashcardChapterWisePage');
                            else if(widget.course==FFAppState().assertionCourseIdInt.toString())
                              context.pushNamed('AssertionChapterWisePage');
                          }
                          else {
                              Navigator.pop(context);
                          }
