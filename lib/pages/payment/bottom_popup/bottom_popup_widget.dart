...
class BottomPopupWidget extends StatefulWidget {
  const BottomPopupWidget({
    ...
    bool? hasShipment
        ...
        this.email = email ?? 'abc@xyz.com',
        this.hasShipment = hasShipment ?? false,
        super(key: key);
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                errorText: _model.submitted ?_model.errorTextForPhoneNumber:null,
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                        ...
                                        children:[
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              validator: _model.address1Validator
                                                  .asValidator(context),
                                            ),
                                          ),
                                          Padding(
                                          ...
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              validator: _model.pincodeValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              validator: _model.stateValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              validator: _model.cityValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                          Padding(
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        setState(() => _model.submitted = true);
                                        if(_model.errorTextForUserName==null && _model.errorTextForPhoneNumber==null)
                                        Navigator.pop(
                                            context,
                                            getJsonField(
                                              functions.packageJSON(
