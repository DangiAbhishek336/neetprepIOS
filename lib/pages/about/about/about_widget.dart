                          ...
                          child: RichText(
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text:
                                      '\"NEETprep Essential\" is an initiative by ',
                                  style: TextStyle(),
                                ),
                                TextSpan(
                                ...
                                TextSpan(
                                  text:
                                      'Currently, we provide an online question bank and tests  portal for admission to under-graduate medical programmes in India.',
                                  style: TextStyle(),
                                )
                              ],
