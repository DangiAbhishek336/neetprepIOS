...
import 'package:neetprep_essential/components/assertion_chap_button/assertion_chap_button_widget.dart';
...
class HardestQsChapterPageWidget extends StatefulWidget {
  const HardestQsChapterPageWidget({super.key});

  @override
  State<HardestQsChapterPageWidget> createState() =>
      _HardestQsChapterPageWidgetState();
}

class _HardestQsChapterPageWidgetState
    extends State<HardestQsChapterPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FirebaseAnalytics.instance.setCurrentScreen(
        screenName: "HardestQsChapterWisePage",
      );
      CleverTapService.recordPageView("HardestQs Chapter Wise  Page Opened");
      var _model =
          Provider.of<HardestQsChapterPageModel>(context, listen: false);
      ...
      await _model.callLoginApi(context).then((value) {});
  ...
  Widget build(BuildContext context) {
    return Consumer<HardestQsChapterPageModel>(
          ...
          return Stack(
            children: [
              Scaffold(
                ...
                key: scaffoldKey,
                drawer: DrawerWidget(DrawerStrings.hardestQsCourse),
                ...
                //  bottomNavigationBar:
                // //  practiceChapModel.courseStatus=="TRIAL" && practiceChapModel.daysLeft!=0 && practiceChapModel.daysLeft!=null? Container(
                ...
                // //          fit: BoxFit.cover,
                // //          image:FFAppState().isDarkMode?Image.asset(
                ...
                // //                      FFAppState().hardestQsCourseIdInt.toString(),
                    ...
                    await context.pushNamed(
                      ...
                      queryParameters: {
                        ...
                        'courseIdInts': serializeParam(
                          FFAppState().hardestQsCourseIdInts,
                          ParamType.String,
                        ),
                      }.withoutNulls,
          ...
          children: [
            ...
            ...List<Widget>.from(
              (topic['questionSets']['edges'] as List).map(
                (questionSet) => AssertionChapButtonWidget(
                  key: Key('Key59l_${questionSet['node']['name']}_of_${index}'),
                  ...
                  courseId: FFAppState().hardestQsCourseIdInt,
                  hasAccess: true,
                ),
              ),
            ),
