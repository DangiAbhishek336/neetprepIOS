...
class _PracticeFreeQuestionsPageWidgetState
  ...
  void initState() {
    ...
    FirebaseAnalytics.instance.setCurrentScreen(screenName: "PracticeFreeQuestionsPage");
    // On page load action.
                                                                                      ...
                                                                                      child: InkWell(
                                                                                        ...
                                                                                        onTap: () async {
                                                                                          ...
                                                                                          if (getJsonField(
                                                                                              ...
                                                                                              null) {
                                                                                            setState(() {
                                                                                              FFAppState().allQuestionsStatus = functions.getUpdatedQuestionsStatusList(FFAppState().allQuestionsStatus.toList(), quetionListIndex, queNumbersIndex,null).toList().cast<dynamic>();
                                                                                            });
                                                                                            setState(() {
