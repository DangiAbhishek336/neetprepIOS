...
import 'essential_search_page_model.dart';


class EssentialSearchPageWidget extends StatefulWidget {
  const EssentialSearchPageWidget({
    Key? key,
    bool? hasAccess,
    int? courseIdInt,
    String? courseIdInts
  ...
  @override
  _EssentialSearchPageWidgetState createState() =>
      _EssentialSearchPageWidgetState();
}

class _EssentialSearchPageWidgetState extends State<EssentialSearchPageWidget> {
  late EssentialSearchPageModel _model;
  ...
  void initState() {
    super.initState();
    FirebaseAnalytics.instance.setCurrentScreen(screenName: "EssentialSearchPage");
     CleverTapService.recordPageView("Essential Search Page Opened");
    loadSearchHistory();
    _model = createModel(context, () => EssentialSearchPageModel());
  ...
  void loadSearchHistory() async {
    ...
    List<dynamic>? searchHistoryStrings = prefs.getStringList('EssentialSearchHistory');
  ...
  void saveSearchHistory() async {
    ...
    List<String> searchHistoryStrings = searchHistory
        ...
        .toList();
    await prefs.setStringList('EssentialSearchHistory', searchHistoryStrings);
  }

  void addToSearchHistory(String id, String name,String numQs) {
    setState(() {
      List<dynamic> historyItem = [id, name,numQs];
                                              ...
                                              setState(() {
                                                ...
                                                _model.simpleSearchResults =
                                                    FFAppState()
                                                      ...
                                                      item['sections'];
                                                      print( _model.simpleSearchResults.toString());
;
                                                      if (sections != null) {
                                                        for (dynamic section
                                                        in sections) {
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                ...
                                                addToSearchHistory(
                                                    serachResultsItemId,
                                                    serachResultsItemName,serachResultsItemNumQuestions);
                                                _model.numTabs =
                                                ...
                                                widget.hasAccess &&   serachResultsItemNumQuestions!="0"?
                                                context.pushNamed(
                            ...
                            child: Expanded(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  String numQs = _model.searchResRev[index][2];
                                  print(numQs+"number of Questions");
                                  return Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        16, 0, 16, 0),
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            hoverColor: Colors.transparent,
                                            highlightColor: Colors.transparent,
                                            onTap: widget.hasAccess?
                                                ()async {
                                              // _model.showSearchRes = false;
                                              addToSearchHistory(id, name,numQs);
                                              _model.numTabs =
                                              await actions.getTabs(
                                                101,
                                              );
