...
import 'assertion_search_page_model.dart';


class AssertionSearchPageWidget extends StatefulWidget {
  const AssertionSearchPageWidget({
    Key? key,
    bool? hasAccess
  ...
  @override
  _AssertionSearchPageWidgetState createState() =>
      _AssertionSearchPageWidgetState();
}

class _AssertionSearchPageWidgetState extends State<AssertionSearchPageWidget> {
  late AssertionSearchPageModel _model;
  ...
  void initState() {
    super.initState();
    FirebaseAnalytics.instance.setCurrentScreen(screenName: "AssertionSearchPage");
    CleverTapService.recordPageView("Assertion Search Page Opened");
    loadSearchHistory();
    _model = createModel(context, () => AssertionSearchPageModel());
  ...
  void loadSearchHistory() async {
    ...
    List<dynamic>? searchHistoryStrings = prefs.getStringList('AssertionSearchHistory');
  ...
  void saveSearchHistory() async {
    ...
    List<String> searchHistoryStrings = searchHistory
        ...
        .toList();
    await prefs.setStringList('AssertionSearchHistory', searchHistoryStrings);
  }
                                            ...
                                            Duration(milliseconds: 200),
                                              ...
                                              setState(() {
                                                ...
                                                _model.simpleSearchResults =
                                                    FFAppState()
                                                        .allSearchItemsForAssertionReason
                                                        .where((item) {
